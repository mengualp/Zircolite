...
**Alternative:** Open a [new issue](https://github.com/wagga40/Zircolite/issues/new) and add a clear note that it is a security-sensitive report. Avoid posting exploit details or proof-of-concept code in public issues; we can switch to a private channel if needed.

### What to expect

- We will acknowledge your report and aim to triage it promptly.
